...
train_dir = r'D:\skin disease dataset\archive\Split_smol\train'
val_dir = r'D:\skin disease dataset\archive\Split_smol\val'
features_dir = r'D:\Skin-disease-detection'
