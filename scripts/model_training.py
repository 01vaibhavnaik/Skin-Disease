...
train_features_path = r'D:\Skin-disease-detection\train_hog_features.pkl'  # Path to training HOG features
train_labels_path = r'D:\Skin-disease-detection\train_labels.npy'  # Path to training labels
models_dir = r'D:\Skin-disease-detection\models'  # Directory where the trained models will be saved
