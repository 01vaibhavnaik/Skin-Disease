            ...
            <div class="flex">
                <div class="box">
                    ...
                    <div class="input-field">
                        ...
                        <input type="email" name="email" required maxlength="30" placeholder="Enter your email" class="input">
                    </div>
                    <div class="input-field">
                ...
                <div class="box">
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" name="city" required maxlength="30" placeholder="e.g city name" class="input">
                    </div>
                    <div class="input-field">
                        <p>country name<span>*</span></p>
                        <input type="text" name="country" required maxlength="30" placeholder="e.g country name" class="input">
                    </div>
                    <div class="input-field">
                        <p>pincod<span>*</span></p>
