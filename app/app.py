...
app = Flask(__name__, template_folder=r'D:\Skin-disease-detection\templates', 
            static_folder=r'D:\Skin-disease-detection\static')
...
val_hog_features = pickle.load(open(r'D:\Skin-disease-detection\val_hog_features.pkl', 'rb'))
...
def predict():
    ...
    if file and allowed_file(file.filename):
        ...
        file_path = os.path.join(r'D:\Skin-disease-detection\uploads', filename)
        file.save(file_path)
        ...
        try:
            ...
            file_path = os.path.join(r'D:\Skin-disease-detection\uploads', 'captured_image.png')
...
def uploaded_file(filename):
    return send_from_directory(r'D:\Skin-disease-detection\uploads', filename)

# Ensure uploads directory exists
if __name__ == '__main__':
    os.makedirs(r'D:\Skin-disease-detection\uploads', exist_ok=True)
    app.run(debug=True)
